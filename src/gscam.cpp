...
std::string camera_parameter_file;
...
int main(int argc, char** argv) {
    ...
    nh.param("camera_info_path", camera_parameter_file, std::string("camera_parameters.txt"));

	if (camera_calibration_parsers::readCalibrationIni(camera_parameter_file, camera_name, camera_info)) {
	...
	ros::ServiceServer set_camera_info = nh.advertiseService("set_camera_info", setCameraInfo);
	...
	while(nh.ok()) {
        ...
        msg.header.frame_id = "logitech_cam";

        camera_info.header.stamp = msg.header.stamp;
        camera_info.header.frame_id = "logitech_cam";
...
bool setCameraInfo(sensor_msgs::SetCameraInfo::Request &req, sensor_msgs::SetCameraInfo::Response &rsp) {
  ...
  if (camera_calibration_parsers::writeCalibrationIni(camera_parameter_file, camera_name, camera_info)) {
